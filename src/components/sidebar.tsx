    ...
    <aside className={`flex-col ${mobile || !collapsed ? "w-64" : "w-16"} h-screen bg-[#0A1628] text-white border-r border-white/10 z-40 transition-[width] ${
      ...
      <ScrollArea className="flex-1 px-3 py-4">
        <nav className="space-y-1">
          ...
          <Link href={`/workspace/${workspaceId || "drehomes"}/reels`}>
            <Button
              variant="ghost"
              className={`w-full justify-start gap-3 text-white/80 hover:bg-white/10 hover:text-white ${
                pathname.includes("/reels") ? "bg-white/10 text-white" : ""
              }`}
            >
          ...
          <Link href={`/workspace/${workspaceId || "drehomes"}/creative-studio`}>
            <Button
              variant="ghost"
              className={`w-full justify-start gap-3 text-white/80 hover:bg-white/10 hover:text-white ${
                pathname.includes("/creative-studio") ? "bg-white/10 text-white" : ""
              }`}
            >
          ...
          <Link href={`/workspace/${workspaceId || "drehomes"}/veo-studio`}>
            <Button
              variant="ghost"
              className={`w-full justify-start gap-3 text-white/80 hover:bg-white/10 hover:text-white ${
                pathname.includes("/veo-studio") ? "bg-white/10 text-white" : ""
              }`}
            >
