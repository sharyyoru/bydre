...
function ProjectsDisplay({ projects, contactsById, company }: { projects: Project[]; contactsById: Map<string, Contact>; company: Company }) {
  ...
  // Get social handle (prefer Instagram)
  const socialHandle = company.social_instagram || company.social_facebook || company.social_twitter || company.social_linkedin || company.social_tiktok;
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-[11px] font-medium text-slate-600 shadow-sm transition-all hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
          >
            <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="m15 18-6-6 6-6" />
            </svg>
