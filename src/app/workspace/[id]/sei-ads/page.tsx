...
export default function SEIAdsPage() {
  ...
  const fetchLeads = async () => {
    try {
      const response = await fetch("/api/sei-leads");
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">SEI Saadiyat Ads</h1>
            <p className="text-muted-foreground text-sm">
              Leads from SEI Saadiyat landing page
            </p>
          </div>
        </div>
        <Button
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground text-sm">
                Leads from the SEI Saadiyat landing page will appear here.
              </p>
            </div>
          ) : (
