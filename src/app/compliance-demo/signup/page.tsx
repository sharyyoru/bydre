...
export default function ComplianceDemoSignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        ...
        const res = await fetch("/api/compliance-demo/setup", {
          method: "POST",
          ...
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <p className="text-center text-sm text-slate-400">
                ...
                <Link href="/compliance-demo/login" className="text-emerald-400 hover:text-emerald-300">
                  Sign in
                </Link>
              </p>
            </form>
